...
function apollo13framework_flyout_box(){
	...
	if( ($defined && $hs) || $enabled ) {
		...
		<div class="<?php echo esc_attr( $hs ? 'demo-flyout ' : '' ); ?>flyout-box" id="a13-flyout-box">
			...
			<span class="drag-out fa fa-<?php echo esc_attr($apollo13framework_a13->get_option( 'flyout_box_icon', 'info-circle' )); ?>" title="<?php esc_attr_e( 'Secret useful links', 'fatmoon' ); ?>"></span>
		</div>
		<?php
	}
}
