	...
	switch( $option['type'] ) {
		...
		case 'wp_dropdown_albums':
			...
			if ($r->have_posts()) :
				...
				$args['choices'][0] = esc_html__( 'There are no albums yet!', 'fatmoon' );
		...
		case 'wp_dropdown_works':
			...
			if ($r->have_posts()) :
				...
				$args['choices'][0] = esc_html__( 'There are no works yet!', 'fatmoon' );
...
function apollo13framework_customizer_controls_js(){
	...
	$human_variants = array(
		'100' => esc_html__( 'thin', 'fatmoon' ),
		'200' => esc_html__( 'extra-light', 'fatmoon' ),
		'300' => esc_html__( 'light', 'fatmoon' ),
		'400' => esc_html__( 'regular', 'fatmoon' ),
		'500' => esc_html__( 'medium', 'fatmoon' ),
		'600' => esc_html__( 'semi-bold', 'fatmoon' ),
		'700' => esc_html__( 'bold', 'fatmoon' ),
		'800' => esc_html__( 'extra-bold', 'fatmoon' ),
		'900' => esc_html__( 'black', 'fatmoon' ),
	);
