	...
	class A13fe_Widget_Contact_Info extends WP_Widget {
		...
		function __construct() {
			$widget_ops = array( 'classname'   => 'widget_contact_info',
			                     'description' => esc_html__( 'Contact information', 'a13_framework_cpt' )
			);
			parent::__construct( 'contact-info', esc_html__( 'Contact information', 'a13_framework_cpt' ), $widget_ops );
		...
		function widget( $args, $instance ) {
			...
			$title = apply_filters( 'widget_title', empty( $instance['title'] ) ? esc_html__( 'Contact information', 'a13_framework_cpt' ) : $instance['title'], $instance, $this->id_base );
		...
		function form( $instance ) {
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'content' ) ); ?>"><?php esc_html_e( 'Content:', 'a13_framework_cpt' ); ?></label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'phone' ) ); ?>"><?php esc_html_e( 'Phone:', 'a13_framework_cpt' ); ?></label>
				<input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'phone' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'phone' ) ); ?>" type="text" value="<?php echo esc_attr( $phone ); ?>" />
			</p>
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'fax' ) ); ?>"><?php esc_html_e( 'Fax:', 'a13_framework_cpt' ); ?></label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'email' ) ); ?>"><?php esc_html_e( 'E-mail:', 'a13_framework_cpt' ); ?></label>
				<input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'email' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'email' ) ); ?>" type="text" value="<?php echo esc_attr( $email ); ?>" />
			</p>
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'www' ) ); ?>"><?php esc_html_e( 'Site:', 'a13_framework_cpt' ); ?></label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'open' ) ); ?>"><?php esc_html_e( 'Open hours info:', 'a13_framework_cpt' ); ?></label>
	...
	class A13fe_Widget_Shortcodes extends WP_Widget {
		...
		function __construct() {
			$widget_ops  = array(
				...
				'description' => esc_html__( 'Widget to put shortcodes in', 'a13_framework_cpt' )
			);
			$control_ops = array( 'width' => 400, 'height' => 350 );
			parent::__construct( 'a13-shortcodes', esc_html__( 'Shortcodes', 'a13_framework_cpt' ), $widget_ops, $control_ops );
		}
		...
		function form( $instance ) {
			...
			<label for="<?php echo esc_attr( $this->get_field_id( 'text' ) ); ?>"><?php esc_html_e( 'Content:', 'a13_framework_cpt' ); ?></label>
			...
			<p>
				<input id="<?php echo esc_attr( $this->get_field_id( 'filter' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'filter' ) ); ?>" type="checkbox" <?php checked( isset( $instance['filter'] ) ? $instance['filter'] : 0 ); ?> />&nbsp;<label for="<?php echo esc_attr( $this->get_field_id( 'filter' ) ); ?>"><?php esc_html_e( 'Automatically add paragraphs', 'a13_framework_cpt' ); ?></label>
			</p>
			<?php
		}
	}
	...
	class A13fe_Widget_Social_Icons extends WP_Widget {
		...
		function __construct() {
			$widget_ops = array( 'classname'   => 'widget_a13_social_icons',
			                     'description' => esc_html__( 'Social icons form theme settings', 'a13_framework_cpt' )
			);
			parent::__construct( 'a13-social-icons', esc_html__( 'Apollo13 Social Icons', 'a13_framework_cpt' ), $widget_ops );
		...
		function form( $instance ) {
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'icons_color' ) ); ?>"><?php esc_html_e( 'Icons color:', 'a13_framework_cpt' ); ?></label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'icons_color_hover' ) ); ?>"><?php esc_html_e( 'Icons color on hover:', 'a13_framework_cpt' ); ?></label>
