...
if ( ! function_exists( 'apollo13framework_get_header_toolbar' ) ) {
	...
	function apollo13framework_get_header_toolbar( &$icons ) {
		...
		//prepare icons HTML
		$tools_html =
		        ( $basket_sidebar ? '<button id="basket-menu-switch" class="'.esc_attr($basket_sidebar_icon).' tool" title="' . esc_attr__( 'Shop sidebar', 'fatmoon' ) . '"><span id="basket-items-count" class="zero">' . esc_html( $woocommerce->cart->cart_contents_count ) . '</span><span class="screen-reader-text">' . esc_attr__( 'Shop sidebar', 'fatmoon' ) . '</span></button>' : '' ) .
		        ( $header_search ? '<button id="search-button" class="'.esc_attr($header_search_icon).' tool" title="' . esc_attr__( 'Search', 'fatmoon' ) . '"><span class="screen-reader-text">' . esc_attr__( 'Search', 'fatmoon' ) . '</span></button>' : '' ) .
		        ( $hidden_sidebar ? '<button id="side-menu-switch" class="'.esc_attr($hidden_sidebar_icon).' tool" title="' . esc_attr__( 'More info', 'fatmoon' ) . '">'.($hs_type === 'animated'? '<i></i>' : '').'<span class="screen-reader-text">' . esc_attr__( 'More info', 'fatmoon' ) . '</span></button>' : '' ) .
		        ( $menu_overlay ? '<button id="menu-overlay-switch" class="'.esc_attr($menu_overlay_icon).' tool" title="' . esc_attr__( 'Main menu', 'fatmoon' ) . '">'.($mo_type === 'animated'? '<i></i>' : '').'<span class="screen-reader-text">' . esc_attr__( 'Main menu', 'fatmoon' ) . '</span></button>' : '' ) .
		        ( $allow_mobile_menu ? '<button id="mobile-menu-opener" class="'.esc_attr($mobile_menu_icon).' tool" title="' . esc_attr__( 'Main menu', 'fatmoon' ) . '">'.($mm_type === 'animated'? '<i></i>' : '').'<span class="screen-reader-text">' . esc_attr__( 'Main menu', 'fatmoon' ) . '</span></button>' : '' ) .
