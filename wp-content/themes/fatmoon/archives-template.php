                    ...
                    <div class="real-content">
                        ...
                        <div class="left50">
                            <h3><?php
                                ...
                                printf( esc_html__( 'Latest %d posts', 'fatmoon' ), 50); ?></h3>
                            <ul class="styled">
                            <?php
                        ...
                        <div class="right50">
                            <h3><?php esc_html_e( 'By months', 'fatmoon' ); ?></h3>
                            <ul class="styled">
                            <?php
                                wp_get_archives(array(
                                'type'            => 'monthly',
                            ...
                            <h3><?php
                                ...
                                printf(  esc_html__( 'Top %d categories', 'fatmoon'  ), 10); ?></h3>
                            <ul class="styled">
                            <?php
                            ...
                            <h3><?php
                                ...
                                printf(  esc_html__( 'Top %d tags', 'fatmoon' ), 10); ?></h3>
                            <ul class="styled">
                            <?php
                                $tags = get_tags(array(
                                    'orderby'            => 'count',
