...
function a13fe_countdown_render( $atts ) {
	...
	$output .= '<div class="a13_count_down ' . $unique_class . ' ' . $style . ' ' . $el_class . '" data-style="' . $style . '" data-weeks="' . esc_html__( 'Weeks', 'a13_framework_cpt' ) . '" data-days="' . esc_html__( 'Days', 'a13_framework_cpt' ) . '" data-hours="' . esc_html__( 'Hours', 'a13_framework_cpt' ) . '" data-minutes="' . esc_html__( 'Minutes', 'a13_framework_cpt' ) . '" data-seconds="' . esc_html__( 'Seconds', 'a13_framework_cpt' ) . '" data-date="' . $date_str . '"></div>';
