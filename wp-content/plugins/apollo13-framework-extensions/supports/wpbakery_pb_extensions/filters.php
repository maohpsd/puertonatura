...
function a13fe_add_grid_shortcodes( $shortcodes ) {
	$shortcodes['vc_a13_team_member'] = array(
		'name'        => __( 'Team member', 'a13_framework_cpt' ),
		'base'        => 'vc_a13_team_member',
		'category'    => __( 'Content', 'a13_framework_cpt' ),
		'description' => '',
		'post_type'   => Vc_Grid_Item_Editor::postType(),
		'params'      => array(
			array(
				"type"       => 'checkbox',
				"heading"    => __( "Show title & subtitle?", 'a13_framework_cpt' ),
				"param_name" => "title_block",
				"value"      => Array( __( "Yes, please", 'a13_framework_cpt' ) => true )
			),
			array(
				"type"       => 'checkbox',
				"heading"    => __( "Show content?", 'a13_framework_cpt' ),
	...
	$shortcodes['vc_a13_testimonial_signature'] = array(
		'name'        => __( 'Testimonial signature', 'a13_framework_cpt' ),
	...
	$shortcodes['vc_a13_post_meta_1'] = array(
		'name'        => __( 'Post metadata bar', 'a13_framework_cpt' ),
	...
	$shortcodes['vc_a13_work_body'] = array(
		'name'        => __( 'Work body', 'a13_framework_cpt' ),
	...
	$shortcodes['vc_a13_product_body'] = array(
		'name'        => __( 'Product body', 'a13_framework_cpt' ),
	...
	$shortcodes['vc_a13_album_body'] = array(
		'name'        => __( 'Album body', 'a13_framework_cpt' ),
	...
	$shortcodes['vc_a13_post_body']  = array(
		'name'        => __( 'Post body', 'a13_framework_cpt' ),
