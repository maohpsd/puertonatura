...
function apollo13framework_wpbakery_plugin_install_details(){
	return array(
		'name'     				=> esc_html__( 'WPBakery Page Builder', 'fatmoon' ),
		'slug'     				=> 'js_composer', 
...
function apollo13framework_elementor_plugin_install_details(){
	return array(
		'name'     				=> esc_html__( 'Elementor', 'fatmoon' ),
		'slug'     				=> 'elementor', 
		'required' 				=> false, 
		'version' 				=> '1.9.1', 
		'force_activation' 		=> false, 
...
function apollo13framework_rife_elementor_extensions_plugin_install_details(){
	return array(
		'name'     				=> esc_html__( 'Rife Elementor Extensions', 'fatmoon' ),
...
function apollo13framework_revoslider_plugin_install_details(){
	return array(
		'name'     				=> esc_html__( 'Revolution Slider', 'fatmoon' ),
		'slug'     				=> 'revslider',
...
function apollo13framework_required_plugins_list(){
	...
	$plugins = array(
		array(
			'name'     				=> esc_html__( 'Apollo13 Framework Extensions', 'fatmoon' ),
