...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20190205_puertonatura_1e9aaeab77d3d0f61620_20190205231138_archive.zip';
	const ARCHIVE_SIZE		 = '61696257';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '1e9aaea-05231138';
	const VERSION			 = '1.3.4';
